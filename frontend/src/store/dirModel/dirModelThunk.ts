...
const dirModelThunk = {
  ...
  >(
    ...
    async (inode, { getState, rejectWithValue }) => {
      ...
      const { containedDirectories, sorting, filter } =
        getState().dirModel;
        ...
        switch (inode) {
          case -1: {
            ...
            const response = await fetch(
              `${API_URL}/api/v1/users/favorites${query}`,
              { credentials: 'include' }
            );
            ...
            if (response.ok) {
              ...
              const camelizedModels = camelize(
                resModels
              ) as ModelMetadata[];
              return {
          ...
          case -2: {
            // Fetch my models
            const response = await fetch(
              `${API_URL}/api/v1/users/myModels${query}`,
              { credentials: 'include' }
            );
          ...
          default: {
            ...
            const response = await fetch(
              `${API_URL}/api/v1/directory/${inode}${query}`,
              { credentials: 'include' }
            );
            ...
            if (response.ok) {
              ...
              return rejectWithValue(
                `Failed to open directory "${containedDirectories[inode].name}"`
              );
          }
        }
      } catch (error) {
        return rejectWithValue(
          `Failed at thunk dirModel/loadDrectoryByInode`
        );
      }
    }
  ),
  ...
  >(
    ...
    async (name: string, { getState, rejectWithValue }) => {
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/v1/directory/?src_inode=${currentInode}&name=${name}`,
          {
            method: 'POST',
            credentials: 'include',
          }
  ...
  >(
    ...
    async ({ inode, name }, { getState, rejectWithValue }) => {
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/v1/directory/?dir_inode=${inode}&new_name=${name}`,
          {
            method: 'PUT',
            credentials: 'include',
          }
        ...
        return rejectWithValue(
          `Failed to rename directory "${containedDirectories[inode].name}"`
        );
      }
    }
  ),
  ...
  >(
    ...
    async (inode, { getState, rejectWithValue }) => {
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/v1/directory/?dir_inode=${inode}`,
          {
            method: 'DELETE',
            credentials: 'include',
          }
        ...
        return rejectWithValue(
          `Failed to detele directory "${containedDirectories[inode].name}"`
        );
      }
    }
  ),
  ...
  >(
    ...
    async ({ id, name }, { getState, rejectWithValue }) => {
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/v1/models/rename?id=${id}&new_name=${name}`,
          {
            method: 'PUT',
            credentials: 'include',
          }
        );
        if (response.ok) return { ...containedModels[id], name };
        throw new Error();
      } catch (error) {
        return rejectWithValue(
          `Failed to rename model "${containedModels[id].name}"`
        );
      }
    }
  ),
  ...
  >(
    ...
    async ({ id, description }, { getState, rejectWithValue }) => {
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/v1/models/updateDescription?id=${id}&description=${description}`,
          {
            method: 'PUT',
            credentials: 'include',
          }
        ...
        return rejectWithValue(
          `Failed to update description in model "${containedModels[id].name}"`
        );
      }
    }
  ),
  ...
  >(
    ...
    async (
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/v1/grant/?reader_mail=${readerMail}&model_id=${modelId}`,
          {
            method: 'POST',
            credentials: 'include',
          }
        ...
        return rejectWithValue(
          `Failed to grant access to model "${targetModel.name}"`
        );
      }
    }
  ),
  ...
  >(
    ...
    async (
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/v1/grant/?reader_email=${readerMail}&model_id=${modelId}`,
          {
            method: 'DELETE',
            credentials: 'include',
          }
        ...
        if (response.ok)
          return {
            ...targetModel,
            sharedReaders: targetModel.sharedReaders.filter(
              (mail) => mail !== readerMail
            ),
          };
        throw new Error();
      } catch (error) {
        return rejectWithValue(
          `Failed to revoke access to model "${targetModel.name}"`
        );
      }
    }
  ),
  ...
  >(
    ...
    async ({ modelId, status }, { getState, rejectWithValue }) => {
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/v1/models/${modelId}/status?status=${status}`,
          {
            method: 'PUT',
            credentials: 'include',
          }
        ...
        return rejectWithValue(
          `Failed to change status of model "${containedModels[modelId].name}"`
        );
      }
    }
  ),
  ...
  >(
    ...
    async (modelId, { getState, rejectWithValue }) => {
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/v1/models/?id=${modelId}`,
          {
            method: 'DELETE',
            credentials: 'include',
          }
        ...
        return rejectWithValue(
          `Failed to delete model "${containedModels[modelId].name}"`
        );
      }
    }
  ),
  ...
  >(
    ...
    async (modelId, { getState, rejectWithValue }) => {
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/v1/users/favorites/${modelId}`,
          {
            method: 'PUT',
            credentials: 'include',
          }
        ...
        return rejectWithValue(
          `Failed to delete model "${targetModel.name}"`
        );
      }
    }
  ),
  ...
  >('dirModel/changeDirAfterMovingModel', async (_, { getState }) => {
    ...
    const {
      ...
      containedDirectories,
      path,
    } = getState().moveFeature;

    return {
      ...currentDirModel,
      currentInode: destination_inode,
      containedModelIds: Object.values(containedModels).map(
        (model) => model.id
      ),
      path,
      containedModels,
